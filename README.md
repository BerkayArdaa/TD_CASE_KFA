...
- **Oyuncu Paneli Objesi:**  
  - Durdurma ekranı için anlatılan butonları içerir.  
...
- **Efekt Animasyonları**: Saldırı, vurulma, can kaybetme (IFrame) gibi aksiyonlarda görsel efekt animasyonları eklenmiştir.  
